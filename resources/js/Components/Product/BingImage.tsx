        ...
        <div className="flex items-center group">
            ...
            {!isLoading && (
                <div className="relative flex justify-center">
                    <img
                        className="aspect-video max-w-[10rem] object-fill"
                        src={image}
                        alt={keyword}
                    />
                    <Button
                        onClick={generateImage}
                        className="hidden top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 absolute group-hover:block"
                    >
                        Generate
                    </Button>
                </div>
